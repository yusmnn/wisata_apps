...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageAsset: 'lib/common/images/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'lib/common/images/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'lib/common/images/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'lib/common/images/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'lib/common/images/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'lib/common/images/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'lib/common/images/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'lib/common/images/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'lib/common/images/ranca-upas.jpg',
    imageUrls: [
